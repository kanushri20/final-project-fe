...
const Dashboard = () => {
  const statEvents = 3;
  const statStudents = 15;
  const statFeedback = 0;
    ...
    <div className="min-h-screen bg-[#0B0E13] text-[#E7EBEF]">
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <h1 className="font-syne text-3xl font-bold">Coordinator Dashboard</h1>
          <p className="text-[#737B8C] mt-1">Manage all aspects of your club events from here.</p>
        </div>

        {/* Stats Row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-[rgba(18,21,28,0.85)] rounded-xl border border-[rgba(37,40,50,0.5)] p-6 text-center">
            <div className="text-3xl font-bold text-[#F97924]">{statEvents}</div>
            <div className="text-[#737B8C] text-sm mt-1">Active Events</div>
          </div>
          <div className="bg-[rgba(18,21,28,0.85)] rounded-xl border border-[rgba(37,40,50,0.5)] p-6 text-center">
            <div className="text-3xl font-bold text-[#F97924]">{statStudents}</div>
